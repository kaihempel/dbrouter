 ...
 */
class UrlSegmentTypeMapperTest extends PHPUnit_Framework_TestCase 
{
    protected $db = NULL;
    ...
    public function testLoadException() 
    {
        ...
        $mapper = new UrlSegmentTypeMapper($db);
    }
    
    public function testNewMapper()
    {
        $mapper = new UrlSegmentTypeMapper($this->db);
        
        $this->assertInstanceOf('Dbrouter\Url\Segment\UrlSegmentTypeMapper', $mapper);
    ...
    public function testCachedData()
    {
        ...
        $mapper1 = new UrlSegmentTypeMapper($this->db);
        
        $this->assertInstanceOf('Dbrouter\Url\Segment\UrlSegmentTypeMapper', $mapper1);
        ...
        $mapper2 = new UrlSegmentTypeMapper($db);
        
        $this->assertInstanceOf('Dbrouter\Url\Segment\UrlSegmentTypeMapper', $mapper2);
